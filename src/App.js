...
import ReservationListsPage from './apps/facility_management/views/ReservationListsPage'
...
const App = () => {
  useEffect(() => {
    signInAnonymously(auth)
      .then(() => {
        // Signed in..
        console.debug('Firebase signed in successfully')
      })
      .catch((error) => {
