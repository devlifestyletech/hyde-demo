...
const ModalPendingBill = () => {
	const { statusModalPending, dataBillingAllApprove, paramsBilling } = useSelector((state) => state.PaymentActionRedux);
	...
	return (
		<div>
										...
										<div className='row'>
											...
											<Row>
												<Col span={12}>
													<div>
														<p>Invoice Bill</p>
														<Input style={{ borderRadius: '25px' }} placeholder='No data form SCB' disabled={true} value={e?.BillsPayment_Invoice} />
													</div>
													<div style={{ paddingTop: 10 }}>
														<p>Address</p>
														<Input style={{ borderRadius: '25px' }} placeholder='No data form SCB' disabled={true} value={e?.Address_Customer} />
													</div>

													<div style={{ paddingTop: 10 }}>
														<p>Name Owner</p>
														<Input style={{ borderRadius: '25px' }} placeholder='No data form SCB' disabled={true} value={e?.Name_Customer} />
													</div>
													...
													<div style={{ paddingTop: 10 }}>
														...
														<Input
															...
															disabled={true}
															value={moment(e?.transactionDateandTime).format('DD/MM/YYYY HH:mm:ss')}
														/>
													</div>
																			...
																			<Row>
																				<Col span={12}>
																					<div style={{ marginRight: 10 }}>
																						<Input style={{ borderRadius: '25px' }} placeholder='No data form SCB' disabled={true} value={e?.subBilling} />
																					</div>
																				</Col>
																				<Col span={12}>
																					<div>
																						<Input style={{ borderRadius: '25px' }} placeholder='No data form SCB' disabled={true} value={e?.amount} />
																					</div>
																				</Col>
																			</Row>
																		</div>
													...
													{e?.payeeProxyId !== undefined ? (
														<div className='row'>
															<div className='col-sm'>
																<div style={{ paddingTop: 10 }}>
																	<p>Biller ID</p>
																	<Input style={{ borderRadius: '25px' }} placeholder='No data form SCB' disabled={true} value={e?.payeeProxyId} />
																</div>
																<div style={{ paddingTop: 10 }}>
																	<p>PayerName</p>
																	<Input style={{ borderRadius: '25px' }} placeholder='No data form SCB' disabled={true} value={e?.payerName} />
																</div>

																<div style={{ paddingTop: 10 }}>
																	<p>Bank transfer</p>
																	<Input style={{ borderRadius: '25px' }} placeholder='No data form SCB' disabled={true} value={bankNamecode(e?.sendingBankCode)} />
																</div>
																<div style={{ paddingTop: 10 }}>
																	<p>Account number</p>
																	<Input style={{ borderRadius: '25px' }} placeholder='No data form SCB' disabled={true} value={e?.payerAccountNumber} />
																</div>
																<div style={{ paddingTop: 10 }}>
																	<p>Total Amount</p>
																	<Input style={{ borderRadius: '25px' }} placeholder='No data form SCB' disabled={true} value={e?.amount} />
												...
												<Col span={12}>
													<div className='col-sm'>
														<div className='container-fluid'>
															<img src={e.imageURL !== null ? e.imageURL : bill} style={{ width: '50%', margin: '30%' }} alt='bill' />
														</div>
													</div>
												</Col>
											</Row>
			...
			<Modal title='Annotation' visible={visible} onOk={rejcetOK} okButtonProps={{ disabled: value === null ? true : false }} onCancel={rejceCancel} okText='ok' cancelText='cancel'>
				<div>
					{/* <p>annotaion</p> */}
