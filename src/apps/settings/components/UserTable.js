...
} from '../../assets/icons/admin_information.svg';
import {ReactComponent as TrashIcon} from '../../assets/icons/admin_trash.svg';
import {
  ReactComponent as DividerIcon,
} from '../../assets/icons/admin_divider.svg';
      ...
      render: (_, {id, idx, role}) => (
          <div key={idx} className={'action_box'}>
            <Row>
              ...
              <Button type={'link'}
                      onClick={() => handleDeleteAccount(id, role)}>
                <TrashIcon/>
              </Button>
            </Row>
          </div>
  ...
  return (
      <>
        ...
        <ModalAccessInfo
            ...
            cancelHandler={() => setModalAccessInfoVisible(
                !modalAccessInfoVisible)}
        />
      </>
  );
}
