...
import { ChatContainer, StyledContainer, ChatBox, ActionIcon, SendIcon, InputBar } from './styles';
		...
		<>
			...
			<ChatContainer>
				<StyledContainer>
					...
					<ChatBox>
						<Header avatar={userAvatar} username={receiver} room={room} handleDisconnect={handleDisconnect} />
						{loading ? <Loading /> : <Messages room={room} messages={messages} />}
						<InputBar>
							<ActionIcon
								onClick={() => {
