...
export default function Facilities() {
  ...
  const [editFacilityModalVisible, setEditfacilityModalVisible] =
    useState(false);
  ...
  return (
    <>
              ...
              >
                  ...
                  <Row>
                    <Col span={8}>
                      <Row>
                        ...
                        {facility.max_users}{' '}
                        <div style={{ marginLeft: 5 }}>Persons</div>
                      </Row>
                    </Col>
                    <Col span={16}>
                      <Row>
                ...
                <div>
                  ...
                  <div style={{ float: 'right', textAlign: 'right' }}>
                    {facility.locked ? (
                      <div
                        style={{ fontSize: 18, color: 'rgba(245, 27, 27, 1)' }}
                      >
                        Not Available
                      </div>
                    ) : (
                      <div
                        style={{ fontSize: 18, color: 'rgba(118, 175, 46, 1)' }}
                      >
                        Available
                      </div>
                    )}
      ...
      <EditFacility
        ...
        id={handleId}
        value={newValues}
        onCancel={() => setEditfacilityModalVisible(false)}
      />
    </>
  );
}
