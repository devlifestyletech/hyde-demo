...
export default function EditOccupation({ visible, onCancel, id, roomName, roomDetail, mediumAt, highAt, image, onEdit, opened, closed }) {
					...
					<div className='md-form'>
						...
						<Form.Item label='Image' name='image'>
							<div>
								{img ? (
									<>
										<img className='facility-image' src={process.env.REACT_APP_API_URL + img} alt='bg' />
