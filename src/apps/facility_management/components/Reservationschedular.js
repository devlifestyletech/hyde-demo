...
export default function SchedularComponent({ reserves }) {
  ...
  let data = reserves.map(
    ({ topic, tel, room_number, name, startDateTime, endDateTime }) => ({
  ...
  const Appointment = (model) => {
    ...
    return (
      <div className="showtime-preview">
        <div>
          <strong style={{ fontFamily: 'SukhumvitSet', fontSize: 16 }}>
        ...
        <div>
          <p style={{ fontFamily: 'SukhumvitSet', fontSize: 16 }}>
