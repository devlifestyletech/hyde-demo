...
function JoinRoom(props) {
	...
	return (
		<>
			{chatState ? (
				<ChatRoom username={username} userId={userId} room={room} joinData={joinData} />
			) : (
				<StyledCard>
					<label htmlFor='username'>
						Enter your name
						<Input name='username' placeholder='Enter your username' maxLength={25} value={username} onChange={onUsernameChange} />
					</label>
					<label htmlFor='room'>
						Enter room number of your choice
						<Input name='room' placeholder='Enter your room number' maxLength={25} value={room} onChange={onRoomChange} />
					</label>
