...
import { EllipsisOutlined, EditOutlined, DeleteOutlined, ExclamationCircleOutlined } from '@ant-design/icons';
				...
				<Col span='10'>
					{user.users_permissions_user.avatar ? (
						<div style={{ textAlign: 'center', margin: 20 }}>
							<img src={process.env.REACT_APP_API_URL + user.users_permissions_user.avatar.url} alt='avatar' style={{ borderRadius: 20, maxHeight: 250 }} />
						</div>
					) : (
						<div>
							<Empty />
